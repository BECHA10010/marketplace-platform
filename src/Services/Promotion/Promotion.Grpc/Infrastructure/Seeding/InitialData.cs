    ...
    public static IEnumerable<Promo> GetInitialPromos =>
        new List<Promo>
        {
            new()
            {
                ...
                Description = "Скидка 100 на продукт: Мультиварка Redmond RMC-M90",
                Value = 100m
            },
            new()
            {
                ...
                Description = "Скидка 1000 на продукт: Смартфон Vitek VT-1234",
                Value = 1000m
            },
            new()
            {
                ...
                Description = "Скидка 150 на продукт: Детский комбинезон Мир детства",
                Value = 150m
            }
        };
}